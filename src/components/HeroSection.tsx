    ...
    <section className="bg-hero-gradient min-h-screen flex items-center py-16 px-4">
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="flex flex-col gap-6">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold text-foreground leading-tight">De R$20 mil por mês a R$100 mil em menos de 1 ano

          </h1>
          <p className="text-xl md:text-2xl font-medium text-foreground/80">Foi o que conquistamos com a Auravie em 2025
          ...
          <button
            ...
            className="bg-cta-green shadow-green-glow text-primary-foreground font-bold text-base md:text-lg px-8 py-4 rounded-full w-fit flex items-center gap-3 hover:scale-105 transition-transform">
